...
class ContainerTypeScreenn extends StatefulWidget {
  final ContainerType ctypes;
  final Function(int) onDelete; // Fonction de suppression par ID
  final Function(int, String, String, String) onUpdate;

  const ContainerTypeScreenn({
    Key? key,
    required this.ctypes,
    required this.onDelete,
    required this.onUpdate,
  }) : super(key: key);

  @override
  _ContainerTypeScreennState createState() => _ContainerTypeScreennState();
}

class _ContainerTypeScreennState extends State<ContainerTypeScreenn> {
  ...
  void initState() {
    super.initState();
    _nameController = TextEditingController(text: widget.ctypes.name);
    _slugController = TextEditingController(text: widget.ctypes.slug);
  }
                ...
                child: Column(
                  ...
                  children: [
                    _buildTextFieldWithBorder(
                        'Nom du Container:', _nameController),
                    _buildTextFieldWithBorder('Slug:', _slugController),
                    _buildTextWithBorder(
                        'Date de création: ${widget.ctypes.createdAt}'),
                    _buildTextWithBorder('ID: ${widget.ctypes.id}'),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ElevatedButton(
